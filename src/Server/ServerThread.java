...
public class ServerThread implements Runnable {
    ...
    public void SendData(String str) throws IOException {
        try {
            ...
            String DVan = STR[3];
            String DAnh = STR[4];
            System.out.println("insert into studentDetail (ID,Name,DiemToan,DiemVan,DiemAnh) values('" + ID + "','" + Name + "','" + DToan + "','" + DVan + "','" + DAnh + "')");
            ...
            String sqlInsert = "insert into studentDetail (ID,Name,DiemToan,DiemVan,DiemAnh) values('" + EncryptID + "','" + EncryptName + "','" + EncryptDToan + "','" + EncryptDVan + "','" + EncryptDAnh + "')";
            try {
            ...
            while (true) {
                ...
                switch (flag(lenh)) {
                    ...
                    case add:
                        ...
                        break;
                    case show:
                        String sqlGetData = "select * from studentDetail";
